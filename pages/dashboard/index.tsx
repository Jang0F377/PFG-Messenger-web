...
import { HeaderDashboardNavLinks } from "../../components/DashboardNavLinks";
  ...
  return (
    <>
      <div id={"dashboard"} className="min-h-full">
        <div className="bg-neon-blue-300 pb-32">
          <HeaderComponent />
          <header className="border-y border-neon-blue-700 py-1">
        ...
        <main className="-mt-32 bg-neon-blue-600 pt-3 md:pt-6 ">
          <section className="mx-auto max-w-7xl px-4 pb-3 sm:px-6 md:pb-6 lg:px-8 xl:pb-8">
            {/* Replace with your content */}
            <div className="mx-auto  items-center justify-center rounded-lg bg-neon-blue-50 px-5 py-6 text-center  sm:px-6">
              <h1 className="-mt-5 pb-1 text-left text-xl font-medium">
                Upcoming Seshes
              </h1>
          ...
          <section className="mx-auto max-w-7xl bg-neon-blue-50 px-4 pb-12 sm:px-6 lg:px-8">
            {/* Replace with your content */}
            <div className="mx-auto  items-center justify-center rounded-lg bg-neon-blue-50 px-5 py-6 text-center  sm:px-6">
              <h1 className="-mt-2 pb-1 text-left text-xl font-medium">
